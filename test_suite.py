...
def evolve_jupiter(min_t10=250.):
    ...
    t0 = time.time()
    jup_rain_superad = evolve.Evolver(z_eos_option='aneos ice')
    try:
        jup_rain_superad.run(mtot=1., yenv=0.27, zenv=0.05, mcore=10., starting_t10=1e3, min_t10=min_t10, nsteps=100., include_he_immiscibility=True, phase_t_offset=-700.,
