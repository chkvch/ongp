...
#log T [K]        log P [GPa]   log rho [g/cc]  log U [MJ/kg] log S [MJ/kg/K]  dlrho/dlT_P,  dlrho/dlP_T,   dlS/dlT_P,     dlS/dlP_T         grad_ad
        ...
        self.spline_kwargs = {'kx':3, 'ky':3} # cubic interpolation in p and t
    ...
    def get_logu_h(self, lgp, lgt):
        return rbs(self.logpvals, self.logtvals, self.data['h']['logu'], **self.spline_kwargs)(lgp, lgt, grid=False)
    def get_logu_he(self, lgp, lgt):
        return rbs(self.logpvals, self.logtvals, self.data['he']['logu'], **self.spline_kwargs)(lgp, lgt, grid=False)
    ...
    def get(self, logp, logt, y):
        ...
        u_h = 10 ** self.get_logu_h(logp, logt)
        u_he = 10 ** self.get_logu_he(logp, logt)
        u = (1. - y) * u_h + y * u_he
